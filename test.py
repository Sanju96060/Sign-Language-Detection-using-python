...
# Path to the model
model_path = r"C:\project\Sign-Language-detection-main\Model\keras_model.h5"
...
if model:
    ...
    if not cap.isOpened():
        ...
        classifier = CustomClassifier(model, r"C:\\project\Sign-Language-detection-main\Data\\labels.txt")
        offset = 20
        imgSize = 300
